...
fr1 = Frame(saudidevorg, bg=bgcolor)
...
Human = Button(fr1, text='VS Human', font=myFont, padx=10,
               command=lambda: raise_frame(mainframe)).pack(side='bottom')
...
txtnameX = Entry(fr1, font=myFont, bg='#f1f2f6',
                   fg="black", bd=2, width=15, justify=LEFT).pack(side=LEFT)
txtnameO = Entry(fr1, font=myFont, bg='#f1f2f6',
                   fg="black", bd=2, width=15, justify=LEFT).pack(side=RIGHT)

lablplayerX = Label(toprightframe, text="PlayerX : ",
...
lablplayerO = Label(toprightframe, textvariable=txtnameO,
                    font=myFont, pady=2, padx=2, bg="#70a1ff").grid(row=1, column=0, sticky=W)
lablplayerO["text"] = txtnameO
