...
button_1 = Button(fr1, text="Enter Names and Start Play VS Human", bd=1, relief=RIDGE, pady=2, padx=2, fon=10, command=Playersname)
...
# Human = Button(fr1, text='VS Human', font=myFont, padx=10,command=lambda: raise_frame(mainframe))  
bback =Button(saudidevorg, text="Go Back", font=myFont,command=raise_frame)
bback.grid(row=2, column=0)
bclose = Button(saudidevorg, text="Exit", font=myFont,command=saudidevorg.destroy)
# Human.grid(row=3, column=1)
