...
label_1 = Label(fr1, text="Enter PlayerX Name", bd=1, relief=RIDGE, pady=2, padx=2)
label_2 = Label(fr1, text="Enter PlayerO Name", bd=1, relief=RIDGE, pady=2, padx=2)
entry_1 = Entry(fr1, bd=3, relief=RIDGE, width=20)
entry_2 = Entry(fr1, bd=3, relief=RIDGE, width=20)
