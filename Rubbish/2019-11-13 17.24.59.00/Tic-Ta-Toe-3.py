...
button_1 = Button(fr1, text="Enter Names and Start Play VS Human", bd=4, relief=RIDGE, pady=2, padx=2, fon=10, command=Playersname)
...
panel = Label(fr1, image = img, width=200)
