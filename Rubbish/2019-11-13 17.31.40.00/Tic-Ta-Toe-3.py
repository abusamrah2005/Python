...
saudidevorg = Tk()
saudidevorg.iconbitmap('8077483 (1).ico')

width_of_window = 820
height_of_window = 630
...
lbtitle = Label(TopFrame, text=" Tic-Ta-Toe Project With saudidevorg ", font=myFont, bd=21, bg="#70a1ff")
lbtitle.grid(row=0, column=0)
mainframe = Frame(saudidevorg, pady=2, padx=2, width=600, bg="#70a1ff",
                  height=500, relief=SOLID, bd=2)
mainframe.grid(row=1, column=0, padx=5)

leftframe = Frame(mainframe, bg="#70a1ff", bd=5,  pady=2,
                  padx=10, width=500, height=500, relief=RIDGE)
leftframe.pack(side=LEFT)

rightframe = Frame(mainframe, bd=5, bg="#70a1ff", pady=2,
...
button_1 = Button(fr1, text="Start Play VS Human", bd=1, relief=RIDGE, pady=2, padx=2, fon=myFont, command=Playersname)
...
# canvas = Canvas(fr1 , width=400, height=400)
# canvas.grid(row=2, column=1,pady=5)
